                ...
                <form action="src/store/Login.php" method="post">
                    ...
                    <div class="separator">
                       <p class="change_link">New to site?
                           <a href="#signup" class="to_register"> signin </a>
                       </p>
<!---->
                       <div class="clearfix"></div>
                        <br />
                        ...
                        <div>
                            <h1><i class="fa fa-paw"></i> Kashyap!</h1>
                            <p>©2017 All Rights Reserved. Vishvas</p>
                        </div>
                    </div>
                </form>
            </section>
            ...
            <section class="login_content">
                <form>
                    ...
                    <div class="separator">
                        ...
                        <div>
                            <h1><i class="fa fa-paw"></i> Vishvas !</h1>
                            <p>©2024All Rights Reserved. Kashyap</p>
                        </div>
                    </div>
                </form>
            </section>
